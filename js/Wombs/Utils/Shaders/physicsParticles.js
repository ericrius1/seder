    ...
    fragment: {
      ...
      wave: [
        ...
        "void main() {",
          "float blueAdd = 0.0;",
          "float random = 0.0;",
          "random = rand(vec2(pos.x, pos.y)) * .9;",
          "blueAdd = pos.y * 0.1;",
          "gl_FragColor = vec4(vec3(pointColor.x, random, pointColor.z + blueAdd) , 1.0);",
        "}"
      ].join("\n"),
      ...
      fire: [
       "uniform vec3 psColor;",
        ...
        "void main() {",
          ...
          "gl_FragColor.y = 0.561;",
          "gl_FragColor.z = myMap(pos.y, -50.0, 70.0, 1.0, 0.0);",

          "gl_FragColor.x = myMap(abs(pos.x), -100.0, 100.0, 0.5, 1.0);",
