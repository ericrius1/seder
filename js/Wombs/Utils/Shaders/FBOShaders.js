      ...
      epicWave:[
        ...
        "void main() {",
          ...
          "} else {",
            ...
            "if (pos.x > 0.0) direction = 1.0;",

            "pos.x += sin( y * 0.006 ) * direction;",
            "pos.y += 0.2;",
     ...
     god: [
        ...
        "void main() {",
          ...
          "} else {",
            ...
            "pos.x += sin( y * xFactor ) * cos( z * yFactor ) * fireSpeed;",
            "pos.y += abs(sin( x * yFactor ) * cos( x * zFactor )) * fireSpeed;",
            "pos.z += sin( x * zFactor ) * cos( y * xFactor ) * fireSpeed;",
            "pos.w -= 0.0000001;",
